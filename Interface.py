...
class Interface:
    ...
    def write_over_choice_function(name, quantity, price=None):
        ...
        digit = re.findall("(y|n)", question_continue, re.IGNORECASE)

        digit_yes = re.search("y", question_continue, re.IGNORECASE)

        digit_no = re.search("n", question_continue, re.IGNORECASE)
...
# I don't know where to put this method
# As it uses one method from Interface and Interface use the product_in_list_check() function
# so if they stay in different files there will be error
